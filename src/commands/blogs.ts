...
<head>
    ...
    <style>
        /* Required default styles for content — scoped to the blog article so
           Tailwind's preflight reset still applies to the global header/footer
           and anything else on the page. */
        [ln-blog-content] :is(blockquote, dd, dl, figure, h1, h2, h3, h4, h5, h6, hr, p, pre) {
            margin: revert;
        }
        [ln-blog-content] :is(menu, ol, ul) {
            list-style: revert;
            margin: revert;
            padding: revert;
        }
