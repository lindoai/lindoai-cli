...
To set the canonical URL, include `<link rel="canonical" href="https://example.com/page">` in the local HTML head before updating. Use `<link rel="canonical" href="">` to clear the override. Omitting the tag preserves the existing canonical URL during updates.
